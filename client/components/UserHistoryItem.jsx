...
function UserHistoryItem({ bookTitle, playlistId}){
    ...
    return(
        ...
        <div  className='text-lg'>
            <div className = 'bookTitle'> <span className='font-bold mr-3'>Title: </span>{bookTitle}</div>
            ...
            <div  className="flex flex-row items-baseline text-right">
                ...
                {/* </div> */}
                <div  id={playlistId} className='self-center bg-primary ml-10 text-white rounded-md py-1 px-10'>PLAY ▷</div>
